...
I optionally add the `base-devel` package as well for developer packages. It also comes with useful packages such as `sudo` and `which` that you will need to install manually if you don't install this package.
