...
## Installing Pacman Hooks (DEPRECIATED - NO LONGER NEEDED)
...
You should also install microcode for your CPU to improve performance and stability. For AMD CPUs, install:
...
This should automatically regenerate your `initramfs`, but you should also regenerate your `grub` configs:
